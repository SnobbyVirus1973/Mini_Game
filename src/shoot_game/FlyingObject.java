...
public abstract class FlyingObject {
    ...
    public boolean isOutOfBounds() {
        return (this.x > World.WIDTH || this.x < -this.width || this.y > World.HEIGHT || this.y < -this.height);
    }
    ...
    public boolean isHit(FlyingObject other) {
        ...
        // 11-22
        // 12-22
        return (x11 + w11 >= x21 && x11 <= x21 + w21 && y11 + h11 >= y21 && y11 <= y21 + h21)
                || (x12 + w12 >= x21 && x12 <= x21 + w21 && y12 + h12 >= y21 && y12 <= y21 + h21)
                || (x12 + w12 >= x22 && x12 <= x22 + w22 && y12 + h12 >= y22 && y12 <= y22 + h22)
                || (x11 + w11 >= x22 && x11 <= x22 + w22 && y11 + h11 >= y22 && y11 <= y22 + h22);
    }
